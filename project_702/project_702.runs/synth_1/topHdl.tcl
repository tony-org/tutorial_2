...
synth_design -top topHdl -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef topHdl.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file topHdl_utilization_synth.rpt -pb topHdl_utilization_synth.pb"
