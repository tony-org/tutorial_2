...
HD_PWD='/home/anthony/git/tony-org/tutorial_2/project_702/project_702.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topHdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topHdl.tcl -notrace
